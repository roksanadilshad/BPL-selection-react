...
const Player = ({player}) => {
    ...
    return (
        <div className='border-1 border-[#cac8c856] rounded-2xl p-5'>
            ...
            <img src={image} alt="" className='w-[300px] h-[200px] rounded-2xl'/>
            ...
            <h5 className='text-[#131313] font-bold text-[16px]'>Rating {rating}</h5><span>Age:{age}</span>
            </div>
            <div className='flex justify-between items-center py-0.5'>

            <h5 className='text-[#131313] font-bold text-[16px]'>{battingStyle} </h5> <span className='text-[#13131386] text-[16px]'>{bowlingStyle}</span>
            </div>
            <div className='flex justify-between items-center pt-0.5'>

            <h5 className='text-[#131313] font-bold text-[16px]'>Price: {price}k</h5>
            <button disabled={isSelected} onClick={() => setIsSelect(true)} class="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl">{isSelected?"Selected":"Choose Player"}</button>
            </div>
